...
export const HeroSection = () => {
  ...
  return (
    <section id="hero" className="pt-24 pb-12 bg-gradient-to-br from-blue-50 via-white to-cyan-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-100 rounded-full opacity-30 blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            {/* Trust Badge */}
            <div className="inline-flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-sm border border-blue-100">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 shadow-lg hover:shadow-xl transition-all"
